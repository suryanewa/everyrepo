...
export default function InfoPanel({ node, neighbors = [], onClose, onNeighborClick, isClosing }) {
    ...
    <div className={`info-panel ${isClosing ? 'closing' : ''}`}>
      ...
      {repoData && (
        <>
          ...
          {repoData.language && (
            <div style={{ fontSize: '13px', color: 'var(--text-secondary)', marginBottom: '12px', display: 'flex', alignItems: 'center', gap: '6px', flexWrap: 'wrap' }}>
              <span style={{
                display: 'inline-block',
                width: '10px',
                height: '10px',
                borderRadius: '50%',
                backgroundColor: LANGUAGE_COLORS[repoData.language] || 'var(--accent)',
                flexShrink: 0
              }}></span>
